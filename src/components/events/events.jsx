        ...
        <div className="events-container">
          <div className="section-content stage1-content active">
            <div className="section-format">
              ...
              <h1>Registration</h1>
              <p>
                🔗 Scan the QR in the poster or click register on top right corner of the screen and
          ...
          <div className="section-content stage3-content">
            <div className="section-format">
              ...
              <p>
                ...
                "Hacked 2.0" will be announced on the 30th of August 2023.
                <br /> <br />
          ...
          <div className="section-content stage4-content">
            <div className="section-format">
              ...
              <p>
                ...
                <br /> <br />
                ⏱️ The "Hacked 2.0" event will begin at 1:00 pm on the 8th of
                ...
                prize winners of the "Hacked 2.0" event on the 9th of September
                2023 by 4:00 pm.
              </p>
            </div>{" "}
          </div>
