      ...
      <div id="faqs" className="parent-faqs">
        ...
        <div className="faqs-section">
          ...
          <div className="faqs-content" onClick={handleArrow}>
            ...
            <p className="faqs-content-description">
              Hacked 2.0 is the first 24-hour national-level hackathon
              organized by the BMU Munjal University in
              collaboration with sata,acm and scimat
            </p>
          </div>
          ...
          <div className="faqs-content" onClick={handleArrow}>
            ...
            <p className="faqs-content-description">
              Hacked 2.0 is open to all undergraduate students from all
